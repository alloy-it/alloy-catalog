# Raspberry Pi 2 Model B Development Environment Blueprint

This blueprint sets up a complete cross-compilation development environment for Raspberry Pi 2 Model B on Linux hosts (amd64 and arm64).
