# Raspberry Pi 5 Development Environment Blueprint

This blueprint sets up a complete cross-compilation development environment for Raspberry Pi 5 (64-bit) on Linux hosts (amd64 and arm64).
