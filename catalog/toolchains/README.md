...
| espressif | riscv32-esp-elf           | `toolchain.espressif.riscv32-esp-elf`           | RISC-V ESP32-C*/H*/P4 and ESP32-S2/S3 ULP. Source: espressif/crosstool-NG. |
| espressif | esp32ulp-elf              | `toolchain.espressif.esp32ulp-elf`              | ESP32/S2/S3 ULP FSM binutils. Source: [espressif/binutils-gdb](https://github.com/espressif/binutils-gdb). |
